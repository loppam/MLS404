  ...
  const fetchStudentClasses = async () => {
    try {
      ...
      timetableSnapshot.forEach((doc) => {
        ...
        const classData = classesList.find((c) => c.id === data.classId);
        const teacherName = teachersMap[data.teacherId] || "Unknown Teacher";

        // Store the timetable entry with all required fields
